...
def run_ml_app():
    ...
    skinthicness=st.number_input('SkinThickness',min_value=0)
    ...
    if st.button('결과 보기'):
        ...
        new_data=np.array([pregnancies,glucose,pressure,skinthicness,insulin,bmi,diabetesPedigreeFunction,age])
